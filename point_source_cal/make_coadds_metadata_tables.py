...
def make_coadds_metadata(region,datadir,wave,mjypbmfactor=537000.0,mjyparcsecfactor=2340.0,weighted=False,goodbox=False,goodboxfilelist=[]):
    ...
    if wave == '450':
        ...
        TCTrigger(sdffiles,'config/protocat.txt','config/diskcat.txt',region,aperture_diam = 0.00089,trigger_thresh = 5, brightness_thresh = 0.0, sd_thresh = 2,wave=wave,mjypbmfactor=mjypbmfactor,mjyparcsecfactor=mjyparcsecfactor,fidnoiseterm=14,fidcalterm=0.02,WEIGHTED=weighted,GOODBOX=goodbox)
